...
<?php
    ...
    <div id="menu1" class="tab-pane fade">
      <center><h3>Remplir cette formulaire</h3></center>
      <div class="container">
...
<div id="map_canvas"></div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
              ...
              <input class="form-control" name="ville" type="text" required="required">
            ...
            <div class="form-group">
                ...
                <input type="telephone" class="form-control" id="telephone" placeholder="votre numéro de telephone" name="telephone">
            </div>
            ...
            <div class="form-group">
               <label for="type">Type:</label>
                <select class="form-control" name="type">
                      ...
                      <option value="Flat Rent">A vendre</option>
                      <option value="Room Rent">location</option>
                </select>
            </div>                      
            <div class="form-group">
                <label for="prix">prix:</label>
                <input type="estimated_price" class="form-control" id="prix" placeholder="prix" name="prix">
            </div>
        </div>

        <div class="col-sm-6">
                  <div class="form-group">
                    <label for="chambre">nombre des chambres:</label>
                    <input type="number" class="form-control" id="chambre" placeholder="" name="chambre">
                  </div>
                  <div class="form-group">
                    <label for="bedroom">salon:</label>
                    <input type="number" class="form-control" id="salon" placeholder="" name="salon">
                  </div>
                  <div class="form-group">
                    <label for="living_room">surface</label>
                    <input type="number" class="form-control" id="living_room" placeholder="" name="surface">
                  </div>
    ...
    <div id="menu2" class="tab-pane fade">
        ...
        if(mysqli_num_rows($result1)>0)
      {
        ...
        $sql="SELECT * from offres where owner_id='$owner_id'";
        $result=mysqli_query($db,$sql);
        ...
        if(mysqli_num_rows($result)>0)
      {
       ...
       ?>
                <tr>
                  ...
                  <td><?php echo $rows['salon'] ?></td>
                  <td><?php echo $rows['surface'] ?></td><td>
<?php $sql2="SELECT * from images where offid='$offid'";
...
<?php $sql2="SELECT * from images where offid='$offid'";
        ...
        if(mysqli_num_rows($query)>0)
      {
          while($row=mysqli_fetch_assoc($query)){ ?>
                ...
                <form method="POST">
                <td>
                  <input type="hidden" name="offid" value="<?php echo $rows['offid']; ?>">
                  <a data-toggle="pill" class="btn btn-success" name="edit_property" onclick="<?php $offid = $rows['offid'] ?>" href="#menu5">Edit</a><input type="submit" class="btn btn-danger" name="delete_property" value="Delete">
                  </td>
                </tr>
                </form>
                <?php }} ?>
...
<script>
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="file" name="photo[]" placeholder="Photos" class="form-control name_list" required accept="image/*" /></td></td> <td><button id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>'); 
      });  
