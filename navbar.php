...
<?php
      ...
      <li><a href="inscri.php"><span class="glyphicon glyphicon-user"></span>inscription</a></li>
      <li><a href="conn.php"><span class="glyphicon glyphicon-log-in"></span> connection</a></li>
    <?php } ?>
    </ul>
  </div>
</nav>
